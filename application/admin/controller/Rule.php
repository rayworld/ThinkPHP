...
class Rule extends Controller
 {
    ...
    public function add(){
        ...
        if ($result) {
            $this->success('添加成功','Index/Rule/rule_list');
        }else{
            $this->error('添加失败');
        }
    }
    ...
    public function edit(){
        ...
        // $result=\app\Index\model\Index::change(["id"=>$data['id']],$info);
        if ($result) {
            $this->success('修改成功','Index/Rule/rule_list');
        }else{
            $this->error('您没有做任何修改');
        }
    }
    ...
    public function delete($id){
        ...
        if($result){
            $this->success('删除成功','Index/Rule/rule_list');
        }else{
            $this->error('请先删除子权限');
        }
    ...
    public function add_group(){
        ...
        if ($result) {
            $this->success('添加成功','Index/Rule/rule_group');
        }else{
            $this->error('添加失败');
        }
    }
    ...
    public function edit_group(){
        ...
        if ($result) {
            $this->success('修改成功','Index/Rule/rule_group');
        }else{
            $this->error('您没有做任何修改');
        }
    }
    ...
    public function delete_group($id){
        ...
        if ($result) {
            $this->success('删除成功','Index/Rule/rule_group');
        }else{
            $this->error('删除失败');
        }
    }
    ...
    public function rule_distribution($id){
        ...
        if($requsest->post()){
            ...
            // $result=Db::name('auth_group')->editData($map,$data);
            if ($result) {
                $this->success('操作成功','Index/Rule/rule_group');
            }else{
                $this->error('操作失败');
            }
        }else{
